...
public:
	...
	int m_tickbase_shift = 0;
	int m_shifted_last_tick = 0;
	bool m_teleported_last_tick = false;
	int m_corrected_tickbase = 0;
	int m_lc_exploit = 0;
	int m_lc_exploit_prev = 0;
	int m_lc_exploit_change = 0;
	int m_lc_exploit_diff = 0;
	std::vector< int > m_shifted_commands;
	std::vector< int > m_sented_commands;
	bool m_breaking_lag_compensation = false;
	float m_last_shot_time = 0.f;
	vec3_t m_local_sent_origin;
};
