...
public:
	...
	__forceinline IMaterial* FindMaterial( const char* name, const char *type ) {
		return  util::get_method< IMaterial*( __thiscall* )( void *, const char*, const char*, bool, void* ) >( this, FINDMATERIAL )( this, name, type, 1, 0 );
	}
