...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flCollisionHeight;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flCollisionChangeTime;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_iClientEntityMask;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bEnableJiggleBones;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bUseNewAnimstate;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( m_flFlashBangTime,            HASH( "DT_CSPlayer" ),             HASH( "m_flFlashDuration" ) );
        ...
        INIT_XOREDNETVAR_SPECIFIC( m_VisualsDataProcessors,      g_netvars.get( HASH( "DT_BaseCombatWeapon" ), HASH( "m_Item" ) ) + 0x230 );
        INIT_XOREDNETVAR_SPECIFIC( m_vecOldOrigin,               0x3AC );
        ...
        INIT_XOREDNETVAR_SPECIFIC( m_bCustomMaterialInitialized, 0x3370 );
        INIT_XOREDNETVAR_SPECIFIC( m_flCollisionHeight,          0x9920 );
        INIT_XOREDNETVAR_SPECIFIC( m_flCollisionChangeTime,      0x9924 );
        INIT_XOREDNETVAR_SPECIFIC( m_iClientEntityMask,          0x26B0 );
        INIT_XOREDNETVAR_SPECIFIC( m_bEnableJiggleBones,         0x2930 );
        INIT_XOREDNETVAR_SPECIFIC( m_bUseNewAnimstate,           0x9B14 );
