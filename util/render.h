...
namespace render {
	...
	void circle_arc( int x, int y, int radius, float start_angle, float end_angle, int segments, Color color );
	...
	void world_circle( vec3_t origin, float radius, Color color, Color color_fill );
